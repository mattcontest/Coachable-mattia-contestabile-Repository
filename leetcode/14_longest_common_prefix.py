...
#    - This means we have reached the end of the string, so there are no more characters to check. 
...
# Eventually, once the conditions are triggered or the loop completes, we return `result`.
